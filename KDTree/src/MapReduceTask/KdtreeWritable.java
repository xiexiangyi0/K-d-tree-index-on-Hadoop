...
import KDIndex.FileLoc;
import KDTree.KDTree;
import KDIndex.Rectangle;
...
public class KdtreeWritable implements Writable {
	...
	*/
	...
	public List<Text> cur_RangeQuery(Rectangle rect) {
		...
		Set<FileLoc> result = kdtree.cur_RangeQuery(rect);
	...
	private int size(){
		return kdtree.size() + rawdata.size()*8;
	}
